...
import com.navkar.myapp.videoplayer.captions.CaptionsView
...
class BetterVideoPlayer @JvmOverloads constructor(
    ...
    override fun onFinishInflate() {
        ...
        (mClickFrame as FrameLayout).foreground = Util.resolveDrawable(context, android.R.attr.selectableItemBackground)
        addView(
        ...
        val mControlsLp = RelativeLayout.LayoutParams(
            ViewGroup.LayoutParams.MATCH_PARENT,
        ...
        val mSubtitlesLp = RelativeLayout.LayoutParams(
            ViewGroup.LayoutParams.MATCH_PARENT,
            ViewGroup.LayoutParams.WRAP_CONTENT
        )
